...
2. in stall the packages u want. by default the version of the packgae will cahnge. to lock on one version, state the version during install eg
npm i validator@10.8.0. this will be shown in package-lock.json.
